...
class ElggSite extends ElggEntity
{
    ...
    public function __construct($guid = null)
    {
        ...
        if (!empty($guid)) {
            ...
            } elseif ($guid instanceof ElggSite) {
     ...
     */
    public function getMembers($options = [], $offset = 0)
    {
        if (!is_array($options)) {
     ...
     * @since 1.8.0
     */
    public function listMembers($options = [])
    {
        $defaults = [
            'site_guids' => ELGG_ENTITIES_ANY_VALUE,
            'relationship' => 'member_of_site',
