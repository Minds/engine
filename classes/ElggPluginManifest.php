...
class ElggPluginManifest
{
    ...
    {
        $bundled_plugins = ['blog', 'bookmarks', 'categories',
        ...
        if (in_array('bundled', $cats, true) && !in_array($this->getPluginID(), $bundled_plugins, true)) {
            unset($cats[array_search('bundled', $cats, true)]);
        }
