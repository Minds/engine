...
class MessageLengthValidatorSpec extends ObjectBehavior
{
    public function it_is_initializable()
    {
        $this->shouldHaveType('Minds\Helpers\StringLengthValidators\MessageLengthValidator');
    }
    ...
    {
        $this->getFieldName()->shouldReturn('message');
    }

    public function it_should_give_limits_as_string()
    {
        $this->limitsToString()->shouldReturn(
            "Invalid message. Must be between 0 and 20000 characters."
        );
    }
