...
class SumsSpec extends ObjectBehavior
{
    ...
    public function it_should_return_the_sum_sent(Client $cassandra, Config $config)
    {
    ...
    public function it_should_return_the_sum_sent_to_receiver(Client $cassandra, Config $config)
    {
        $cassandra->request(Argument::that(function ($query) {
            $values = $query->build()['values'];
    ...
    public function it_should_get_a_sum_by_receiver(Client $cassandra, Config $config)
    {
    ...
    public function it_should_get_a_sum_by_entity(Client $cassandra, Config $config)
    {
