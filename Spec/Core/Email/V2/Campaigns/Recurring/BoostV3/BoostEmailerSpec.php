...
class BoostEmailerSpec extends ObjectBehavior
{
    ...
    public function it_should_build_a_boost_created_email_for_a_tenant_network(
        Boost $boost,
        User $user
    ): void {
        $topic = ActionEvent::ACTION_BOOST_CREATED;
    ...
    public function it_should_build_a_boost_accepted_email_for_a_tenant_network(
        Boost $boost,
        User $user
    ): void {
        $topic = ActionEvent::ACTION_BOOST_ACCEPTED;
    ...
    public function it_should_build_a_boost_completed_email_for_a_tenant_network(
        Boost $boost,
        User $user
    ): void {
        $topic = ActionEvent::ACTION_BOOST_COMPLETED;
    ...
    public function it_should_build_a_boost_rejected_email_for_a_tenant_network(
        Boost $boost,
        User $user
    ): void {
        $topic = ActionEvent::ACTION_BOOST_REJECTED;
