...
class ProEmailSpec extends ObjectBehavior
{
    ...
    public function it_should_build_body_content_array_for_monthly_amount(): void
    {
        ...
        $this->buildBodyContentArray()
            ->shouldBe([
                "Thanks for gifting <b>Minds Pro ($10 for 1 month)</b> to someone lucky. If you selected a recipient during checkout, we've already notified them with details on how they can claim the gift.",
    ...
    public function it_should_build_body_content_array_for_yearly_amount(): void
    {
        ...
        $this->buildBodyContentArray()
            ->shouldBe([
                "Thanks for gifting <b>Minds Pro ($110 for 1 year)</b> to someone lucky. If you selected a recipient during checkout, we've already notified them with details on how they can claim the gift.",
                "<b>Or you can share this claim link</b> with them, whether or not they already have a Minds account."
            ]);
    }
    ...
    public function it_should_build_body_content_array_for_slightly_less_than_yearly_amount(): void
    {
        ...
        $this->buildBodyContentArray()
            ->shouldBe([
                "Thanks for gifting <b>Minds Pro ($109 for 1 month)</b> to someone lucky. If you selected a recipient during checkout, we've already notified them with details on how they can claim the gift.",
                "<b>Or you can share this claim link</b> with them, whether or not they already have a Minds account."
            ]);
    }
    ...
    public function it_should_build_body_content_array_for_slightly_more_than_yearly_amount(): void
    {
        ...
        $this->buildBodyContentArray()
            ->shouldBe([
                "Thanks for gifting <b>Minds Pro ($111 for 1 year)</b> to someone lucky. If you selected a recipient during checkout, we've already notified them with details on how they can claim the gift.",
                "<b>Or you can share this claim link</b> with them, whether or not they already have a Minds account."
            ]);
    }
