...
class PushSpec extends ObjectBehavior
{
    ...
    public function it_should_construct_commented_on_an_image_message(NotificationEntity $notification, User $user, Entity $entity)
    {
        $notification->getData()
            ->shouldBeCalled()
            ->willReturn(['test' => 123]);
        ...
        $this->translator->trans('comment.user.image', Argument::any())
            ->shouldBeCalled()
            ->willReturn("Bob commented on John's image");
        ...
        $this->buildNotificationMessage([
            ...
            'to' => '1',
            'toObj' => $user,
        ], $user, $entity)->shouldBe("Bob commented on John's image");
    }
    ...
    public function it_should_construct_commented_on_a_video_message(NotificationEntity $notification, User $user, Entity $entity)
    {
        ...
        $this->translator->trans('comment.user.video', Argument::any())
            ->shouldBeCalled()
            ->willReturn("Bob commented on John's video");
        ...
        $this->buildNotificationMessage([
            ...
            'to' => '1',
            'toObj' => $user,
        ], $user, $entity)->shouldBe("Bob commented on John's video");
    }
    ...
    public function it_should_construct_commented_on_a_blog_message(NotificationEntity $notification, User $user, Entity $entity)
    {
        ...
        $this->translator->trans('comment.user.blog', Argument::any())
            ->shouldBeCalled()
            ->willReturn("Bob commented on John's blog");
        ...
        $this->buildNotificationMessage([
            ...
            'to' => '1',
            'toObj' => $user,
        ], $user, $entity)->shouldBe("Bob commented on John's blog");
    }
