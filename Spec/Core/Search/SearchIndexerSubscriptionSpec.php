...
class SearchIndexerSubscriptionSpec extends ObjectBehavior
{
    ...
    public function it_should_index_an_activity_with_patched_tags_when_a_user_has_not_yet_posted(
        ...
        $this->cache->get("$ownerGuid:posted")
            ->shouldBeCalled()
            ->willReturn(false);
    ...
    public function it_should_index_an_image_with_patched_tags_when_a_user_has_not_yet_posted(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_an_image_with_patched_tags_when_a_user_has_not_yet_posted_but_posts_with_tags_already(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_an_image_without_patched_tags_when_a_user_already_has_posted_when_looking_in_es(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_an_image_without_patched_tags_when_a_user_already_has_posted_when_stored_in_cache(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_video_with_patched_tags_when_a_user_has_not_yet_posted(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_video_with_patched_tags_when_a_user_has_not_yet_posted_but_posts_with_tags_already(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_video_without_patched_tags_when_a_user_already_has_posted_when_looking_in_es(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_video_without_patched_tags_when_a_user_already_has_posted_when_stored_in_cache(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_blog_with_patched_tags_when_a_user_has_not_yet_posted(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_blog_with_patched_tags_when_a_user_has_not_yet_posted_but_posts_with_tags_already(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_blog_without_patched_tags_when_a_user_already_has_posted_when_looking_in_es(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
    ...
    public function it_should_index_a_blog_without_patched_tags_when_a_user_already_has_posted_when_stored_in_cache(
        User $user
    ) {
        $entityUrn = 'urn:activity:123';
        $ownerGuid = '234';
