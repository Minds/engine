...
class ManagerSpec extends ObjectBehavior
{
    ...
    private Collaborator $multiTenantConfigManager;

    public function let(
        ImagickManager $imagickManager,
        Config $config,
        MultiTenantBootService $multiTenantBootServiceMock,
        MultiTenantConfigManager $multiTenantConfigManager
    ) {
        $this->beConstructedWith($imagickManager, $config, $multiTenantBootServiceMock, $multiTenantConfigManager);
        $this->imagickManager = $imagickManager;
        $this->config = $config;
        $this->multiTenantBootServiceMock = $multiTenantBootServiceMock;
        $this->multiTenantConfigManager = $multiTenantConfigManager;
