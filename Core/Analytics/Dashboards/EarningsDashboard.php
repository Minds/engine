...
class EarningsDashboard implements DashboardInterface
{
    ...
    public function export(array $extras = []): array
    {
        ...
        return [
            'category' => 'earnings',
            'label' => 'Pro Earnings',
            'description' => 'In order to start earning, upgrade to Pro. Earnings for Pro members will be paid out within 30 days upon reaching a minumum balance of $100.00.',
