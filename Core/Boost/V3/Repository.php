...
class Repository
{
    ...
    {
        $query = "INSERT INTO boosts (guid, owner_guid, entity_guid, target_location, payment_method, payment_amount, daily_bid, duration_days, status)
                    VALUES (:guid, :owner_guid, :entity_guid, :target_location, :payment_method, :payment_amount, :daily_bid, :duration_days, :status)";
        $values = [
            'guid' => $boost->getGuid(),
    ...
    public function getBoosts(
        ...
        if ($orderByRanking) {
            ...
            $orderByClause = " ORDER BY boost_rankings.ranking_safe, boost.approved_timestamp DESC";
        }
    ...
    public function getBoostByGuid(string $boostGuid): Boost
    {
        ...
        return new Boost($statement->fetch(PDO::FETCH_ASSOC));
    }
