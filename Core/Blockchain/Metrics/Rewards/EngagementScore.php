...
class EngagementScore extends AbstractBlockchainRewardMetric implements Metrics\BlockchainMetricInterface
{
    /** @var string */
    ...
    {
        return $this->getScore(Manager::REWARD_TYPE_ENGAGEMENT);
    }
