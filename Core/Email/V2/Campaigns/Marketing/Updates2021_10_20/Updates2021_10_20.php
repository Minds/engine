...
class Updates2021_10_20 extends EmailCampaign
{
    use MagicAttributes;
    /** @var Template */
    protected $template;
    ...
    public function build(): Message
    {
        ...
        $subject = "Announcing Minds Chat, Twitter Migration and more";
        ...
        $this->template->set('preheader', "Check out some recent news and product releases all focused on bringing you more freedom and monetization opportunities.");
        $this->template->set('tracking', http_build_query($tracking));

        $actionButton = (new ActionButton())
            ->setLabel('Read our blog')
            ->setPath('minds/blog/in-case-you-missed-it-1297312726715994121?'.http_build_query($tracking));
