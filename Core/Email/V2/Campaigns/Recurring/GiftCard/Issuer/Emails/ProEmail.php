...
class ProEmail implements GiftCardIssuerEmailInterface
{
    ...
    {
        return [
            "Thanks for gifting <b>Minds Pro {$this->getSpanText()}</b> to someone lucky. If you selected a recipient during checkout, we've already notified them with details on how they can claim the gift.",
