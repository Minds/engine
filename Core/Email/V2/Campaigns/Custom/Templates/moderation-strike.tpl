<tr>
    <td>
        <p>
            ...
            <?= $vars['translator']->trans('To appeal this decision to a jury of your peers, please') ?> <a href="https://www.minds.com/settings/other/reported-content" target="_blank" <?php echo $emailStyles->getStyles('m-link'); ?>><?= $vars['translator']->trans('log in') ?></a> <?= $vars['translator']->trans('and submit an appeal to a jury of your peers from the Reported Content section of your settings.') ?>
        </p>
    </td>
</tr>
<tr>
