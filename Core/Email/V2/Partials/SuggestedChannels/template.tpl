<h3 <?php echo $emailStyles->getStyles('m-copy', 'm-newsfeedSidebar__header'); ?>>Suggested channels</h3>
<table <?php echo $emailStyles->getStyles('m-suggestions__sidebar', 'm-clear'); ?> cellspacing="0">
    ...
    <tr id="suggested-channel-<?php echo $entity->getGuid(); ?>">
        ...
        <h4 <?php echo $emailStyles->getStyles('m-clear', 'm-fonts', 'm-newsfeedSidebar__header'); ?>>
            <a <?php echo $emailStyles->getStyles('m-clear', 'm-fonts', 'm-suggestions__link', 'm-newsfeedSidebar__header'); ?> href="<?php echo $channelUrl ?>">
                <?php echo $entity->get('name'); ?>
            </a>
        </h4>
        <p <?php echo $emailStyles->getStyles('m-clear', 'm-fonts', 'm-suggestionsSidebarListItem__description'); ?>>
            <a <?php echo $emailStyles->getStyles('m-clear', 'm-fonts', 'm-suggestions__link', 'm-suggestionsSidebarListItem__description'); ?> href="<?php echo $channelUrl ?>">
