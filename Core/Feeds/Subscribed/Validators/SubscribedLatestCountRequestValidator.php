...
namespace Minds\Core\Feeds\Subscribed\Validators;

use Minds\Entities\ValidationError;
use Minds\Entities\ValidationErrorCollection;

/**
 * Validates the request data for the /api/v3/newsfeed/subscribed/latest/count
 */
class SubscribedLatestCountRequestValidator
{
